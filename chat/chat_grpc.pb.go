...
func (c *chatServiceClient) ReceiveMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (UnimplementedChatServiceServer) ReceiveMessage(context.Context, *Message) (*Empty, error) {
