...
var file_internal_proto_chat_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x32, 0xb3, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x12, 0x2c, 0x0a, 0x0e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x0d, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x1a, 0x0b, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x28,
	...
	0x73, 0x61, 0x67, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x63, 0x68,
...
var file_internal_proto_chat_proto_goTypes = []any{
...
func file_internal_proto_chat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_proto_chat_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_proto_chat_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internal_proto_chat_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_proto_chat_proto_msgTypes[3].Exporter = func(v any, i int) any {
